...
// It MUST NOT import anything from src/teams/send.js — the only code path
// that sends Teams messages is the approval flow (routes/drafts.js).
// See tests/test-safety-boundary.mjs for enforcement.
